    ...
    public class SetNameOrDeleteOptimizedScreen : PopupWindowContent
    {
        ...
        public override void OnGUI(Rect rect)
        {
            ...
            if (renameMode)
            {
                ...
                @"Attention!
Settings for certain screen conditions are mapped by upgradeName.
If you change the upgradeName, your already configured UI Elements
...
but the mapping to its upgradeName will stay connected
to the controls which references it.");
            ...
            else // CREATE MODE
            {
                ...
                EditorGUI.LabelField(new Rect(inner.x, y, inner.width, h),
                @"Give your new Condition a short and clear upgradeName.

Choose the upgradeName wisely. It identifies your condition.

...
namespace TheraBytes.BetterUi.Editor.ThirdParty
{
	...
	public class SerializedPropertyAdaptor : IReorderableListAdaptor {
		...
		/// </summary>
		/// <param upgradeName="arrayProperty">Serialized property for entire array.</param>
		/// <param upgradeName="fixedItemHeight">Non-zero height overrides property drawer height calculation.</param>

...
namespace TheraBytes.BetterUi.Editor.ThirdParty {
	...
	/// simply copied.</para>
	/// </remarks>
	/// <typeparam upgradeName="T">Type of list element.</typeparam>
	public class GenericListAdaptor<T> : IReorderableListAdaptor {
		...
		/// </summary>
		/// <param upgradeName="index">Zero-based index of element.</param>
		/// <returns>
		/// The element.
		/// </returns>
		...
		/// <param upgradeName="itemDrawer">Callback to draw list item.</param>
		/// <param upgradeName="itemHeight">Height of list item in pixels.</param>

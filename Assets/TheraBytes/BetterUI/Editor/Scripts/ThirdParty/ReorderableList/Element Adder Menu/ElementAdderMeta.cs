...
namespace TheraBytes.BetterUi.Editor.ThirdParty
{
	...
	public static class ElementAdderMeta {
		...
		/// that are associated with the specified <paramref upgradeName="contractType"/>.
		/// </summary>
		...
		/// If <paramref upgradeName="contractType"/> is <c>null</c>.
		/// </exception>
		...
		/// specified <paramref upgradeName="contractType"/>.
		/// </summary>
		/// <remarks>
		/// <para>A type is excluded from the resulting array when one or more of the
		/// specified <paramref upgradeName="filters"/> returns a value of <c>false</c>.</para>
		/// </remarks>
		/// <param upgradeName="contractType">Contract type of addable elements.</param>
		/// <param upgradeName="filters">An array of zero or more filters.</param>
		/// <returns>
		...
		/// <paramref upgradeName="contractType"/>.
		/// </summary>
		/// <param upgradeName="contractType">Contract type of addable elements.</param>
		/// <returns>
		/// An array of zero or more concrete element types.

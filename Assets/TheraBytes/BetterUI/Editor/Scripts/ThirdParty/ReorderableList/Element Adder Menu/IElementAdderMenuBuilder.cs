...
namespace TheraBytes.BetterUi.Editor.ThirdParty
{
	...
	public interface IElementAdderMenuBuilder<TContext> {
		...
		/// Only non-abstract class types that are assignable from the <paramref upgradeName="contractType"/>
		/// will be included in the built menu.
		/// </summary>
		/// <param upgradeName="contractType">Contract type of addable elements.</param>
		...
		/// </summary>
		/// <remarks>
		/// <para>Specify a value of <c>null</c> for <paramref upgradeName="elementAdder"/> to
		/// prevent the selection of any types.</para>
		/// </remarks>
		/// <param upgradeName="elementAdder">Element adder.</param>
		...
		/// </summary>
		/// <remarks>
		/// <para>Specify a value of <c>null</c> for <paramref upgradeName="formatter"/> to
		/// assume the default formatting function.</para>
		/// </remarks>
		/// <param upgradeName="formatter">Function that formats display upgradeName of type; or <c>null</c>.</param>
		...
		/// </remarks>
		/// <param upgradeName="typeFilter">Filter function.</param>
		/// <exception cref="System.ArgumentNullException">
		/// If <paramref upgradeName="typeFilter"/> is <c>null</c>.
		/// </exception>
		...
		/// </summary>
		/// <param upgradeName="command">The custom command.</param>
		/// <exception cref="System.ArgumentNullException">
		/// If <paramref upgradeName="command"/> is <c>null</c>.
		/// </exception>

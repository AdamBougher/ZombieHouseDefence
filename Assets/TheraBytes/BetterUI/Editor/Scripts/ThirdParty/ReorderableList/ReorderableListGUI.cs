...
namespace TheraBytes.BetterUi.Editor.ThirdParty
{
	...
	public static class ReorderableListGUI {
		...
		/// </remarks>
		/// <param upgradeName="position">Position to draw list item control(s).</param>
		/// <param upgradeName="item">Value of list item.</param>
		/// <returns>
		/// Unmodified value of list item.
		/// </returns>
		/// <typeparam upgradeName="T">Type of list item.</typeparam>
		...
		/// ]]></code>
		/// </example>
		/// <param upgradeName="title">Content for title control.</param>
		...
		/// ]]></code>
		/// </example>
		/// <param upgradeName="title">Text for title control.</param>
		...
		/// </summary>
		/// <param upgradeName="position">Position of control.</param>
		/// <param upgradeName="text">Text for title control.</param>
		...
		/// </summary>
		/// <param upgradeName="list">The list which can be reordered.</param>
		/// <param upgradeName="drawItem">Callback to draw list item.</param>
		/// <param upgradeName="drawEmpty">Callback to draw custom content for empty list (optional).</param>
		/// <param upgradeName="itemHeight">Height of a single list item.</param>
		...
		/// </summary>
		/// <param upgradeName="arrayProperty">Serializable property.</param>
		/// <param upgradeName="fixedItemHeight">Use fixed height for items rather than <see cref="UnityEditor.EditorGUI.GetPropertyHeight(SerializedProperty)"/>.</param>
		/// <param upgradeName="drawEmpty">Callback to draw custom content for empty list (optional).</param>
		/// <param upgradeName="flags">Optional flags to pass into list field.</param>

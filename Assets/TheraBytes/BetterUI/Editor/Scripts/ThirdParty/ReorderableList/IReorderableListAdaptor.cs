...
namespace TheraBytes.BetterUi.Editor.ThirdParty
{
	...
	public interface IReorderableListAdaptor {
		...
		/// </remarks>
		/// <param upgradeName="index">Zero-based index for list element.</param>
		/// <returns>
		...
		/// </remarks>
		/// <param upgradeName="index">Zero-based index of list element.</param>
		...
		/// </summary>
		/// <param upgradeName="sourceIndex">Zero-based index of source element.</param>
		/// <param upgradeName="destIndex">Zero-based index of destination element.</param>
		...
		/// </remarks>
		/// <param upgradeName="position">Total position of list element in GUI.</param>
		/// <param upgradeName="index">Zero-based index of array element.</param>
		...
		/// </remarks>
		/// <param upgradeName="position">Position in GUI.</param>
		/// <param upgradeName="index">Zero-based index of array element.</param>

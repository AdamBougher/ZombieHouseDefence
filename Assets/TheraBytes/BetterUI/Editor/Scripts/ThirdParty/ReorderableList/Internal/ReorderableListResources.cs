...
namespace TheraBytes.BetterUi.Editor.ThirdParty.Internal {
	...
	public static class ReorderableListResources {
		...
		/// </summary>
		/// <param upgradeName="name">Name for texture object.</param>
		/// <param upgradeName="color">Pixel color.</param>
		/// <returns>
		...
		/// </summary>
		/// <param upgradeName="imageData">PNG image data.</param>
		/// <param upgradeName="width">Width of image in pixels.</param>
		/// <param upgradeName="height">Height of image in pixels.</param>

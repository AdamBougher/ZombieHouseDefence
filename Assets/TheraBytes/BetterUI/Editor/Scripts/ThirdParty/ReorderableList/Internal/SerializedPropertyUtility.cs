...
namespace TheraBytes.BetterUi.Editor.ThirdParty.Internal {
	...
	public static class SerializedPropertyUtility {
		...
		/// </summary>
		/// <param upgradeName="property">Serialized property for a serialized property.</param>
		...
		/// <summary>
		/// Copies value of <paramref upgradeName="sourceProperty"/> into <pararef upgradeName="destProperty"/>.
		/// </summary>
		/// <param upgradeName="destProperty">Destination property.</param>
		/// <param upgradeName="sourceProperty">Source property.</param>

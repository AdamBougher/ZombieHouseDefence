...
namespace TheraBytes.BetterUi.Editor.ThirdParty
{
	...
	public class ReorderableListControl {
		...
		/// ]]></code>
		/// </example>
		/// <typeparam upgradeName="T">Type of item list.</typeparam>
		/// <param upgradeName="position">Position of list item.</param>
		/// <param upgradeName="item">The list item.</param>
		/// <returns>
		/// The modified value.
		/// </returns>
		...
		/// </summary>
		/// <param upgradeName="position">Position of empty content.</param>
		...
		/// <param upgradeName="drawEmpty">Delegate for drawing empty list.</param>
		/// <param upgradeName="flags">Optional flags to pass into list field.</param>
		...
		/// Generate and draw control from state object.
		/// </summary>
		/// <param upgradeName="position">Position of control.</param>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
		/// <param upgradeName="drawEmpty">Delegate for drawing empty list.</param>
		/// <param upgradeName="flags">Optional flags to pass into list field.</param>
		...
		/// Initializes a new instance of <see cref="ReorderableListControl"/>.
		/// </summary>
		/// <param upgradeName="flags">Optional flags which affect behavior of control.</param>
		...
		/// </summary>
		/// <param upgradeName="controlID">Unique ID of list control.</param>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
		...
		/// </summary>
		/// <param upgradeName="controlID">Unique ID of list control.</param>
		/// <param upgradeName="itemIndex">Zero-based index of list item.</param>
		...
		/// Draw remove button.
		/// </summary>
		/// <param upgradeName="position">Position of button.</param>
		/// <param upgradeName="visible">Indicates if control is visible within GUI.</param>
		/// <returns>
		...
		/// </summary>
		/// <param upgradeName="controlID">Unique ID of list control.</param>
		/// <param upgradeName="itemIndex">Zero-based index of item which is going to be dragged.</param>
		...
		/// </summary>
		/// <param upgradeName="position">Position of list control in GUI.</param>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
...
//*/
		...
		/// </remarks>
		/// <param upgradeName="position">Position if the drop indicator.</param>
		...
		/// </summary>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
		/// <param upgradeName="padding">Padding in pixels.</param>
		/// <returns>
		...
		/// </summary>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
		/// <param upgradeName="drawEmpty">Callback to draw empty content.</param>
		/// <returns>
		/// Position of list container area in GUI (excludes footer area).
		/// </returns>
		...
		/// </summary>
		/// <remarks>
		/// <para>Specify a value of <c>GUIContent.none</c> for argument <paramref upgradeName="label"/>
		/// to omit prefix label from the drawn control.</para>
		/// </remarks>
		/// <param upgradeName="position">Position of list control in GUI.</param>
		/// <param upgradeName="label">Prefix label for the control.</param>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
		...
		// Command upgradeName is assigned by default context menu handler.
		...
		/// </summary>
		/// <param upgradeName="menu">Menu which can be populated.</param>
		/// <param upgradeName="itemIndex">Zero-based index of item which was right-clicked.</param>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
		...
		/// ]]></code>
		/// </remarks>
		/// <param upgradeName="commandName">Name of command. This is the text shown in the context menu.</param>
		/// <param upgradeName="itemIndex">Zero-based index of item which was right-clicked.</param>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
		/// <returns>
		...
		/// <para>Warning message is logged to console if attempted to execute unknown command.</para>
		/// </remarks>
		/// <param upgradeName="command">Content representing command.</param>
		/// <param upgradeName="itemIndex">Zero-based index of item which was right-clicked.</param>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
		/// <returns>
		/// A value of <c>true</c> if command was known; otherwise <c>false</c>.
		...
		/// Calculate height of list control in pixels.
		/// </summary>
		/// <param upgradeName="itemCount">Count of items in list.</param>
		/// <param upgradeName="itemHeight">Fixed height of list item.</param>
		/// <returns>
		/// Required list height in pixels.
		/// </returns>
		...
		/// </summary>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
		/// <param upgradeName="sourceIndex">Zero-based index of source item.</param>
		/// <param upgradeName="destIndex">Zero-based index of destination index.</param>
		...
		/// </summary>
		/// <param upgradeName="adaptor">Reorderable list adaptor.</param>
		/// <param upgradeName="newCount">New count of items.</param>
		/// <returns>
		/// Returns a value of <c>false</c> if operation was cancelled.
		/// </returns>

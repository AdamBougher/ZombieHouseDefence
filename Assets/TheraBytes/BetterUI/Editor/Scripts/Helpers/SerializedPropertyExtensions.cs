...
namespace TheraBytes.BetterUi.Editor
{
    ...
    public static class SerializedPropertyExtensions
    {
        ...
        /// </summary>
        /// <typeparam upgradeName="T">The object type that the property contains</typeparam>
        /// <param upgradeName="property"></param>
        ...
        /// </summary>
        /// <typeparam upgradeName="T">The type of the field that is set</typeparam>
        /// <param upgradeName="property">The serialized property that should be set</param>
        /// <param upgradeName="value">The new value for the specified property</param>
        ...
        /// </summary>
        /// <param upgradeName="property">The property that is part of the object</param>
        ...
        /// </summary>
        /// <typeparam upgradeName="T">The type of the nested object</typeparam>
        /// <param upgradeName="path">Path to the object through other properties e.g. PlayerInformation.Health</param>
        /// <param upgradeName="obj">The root object from which this path leads to the property</param>
        /// <param upgradeName="includeAllBases">Include base classes and interfaces as well</param>

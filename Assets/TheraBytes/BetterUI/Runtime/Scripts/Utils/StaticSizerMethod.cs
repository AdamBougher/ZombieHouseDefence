...
namespace TheraBytes.BetterUi
{
    ...
    public class StaticSizerMethod
    {
        ...
        public float Invoke(Component caller, Vector2 optimizedResolution, Vector2 actualResolution, float optimizedDpi, float actualDpi)
        {
            ...
            if (assembly == null)
            {
                Debug.LogErrorFormat("Static Sizer Method: Assembly with upgradeName '{0}' could not be found.", assemblyName);
                return 0;
            }
            ...
            if(t == null)
            {
                Debug.LogErrorFormat("Static Sizer Method: Type '{0}' could not be found in assembly '{1}'. Make sure the upgradeName contains the full namespace.", typeName, assemblyName);
                return 0;
            }
